...
public class P1Controller2D : RaycastController
{
	...
	void  InnerCollisions ()
	{
		...
		if (hit1)
		{
			if (hit1.collider.tag == "Block" && hitC == false)
			{
				Player1.player.Squish();
				respawn.P1StartRespawn ();
				Destroy (gameObject);
				hitC = true;
			}
		...
		if (hit2)
		{
			if (hit2.collider.tag == "Block" && hitC == false)
			{
				Player1.player.Squish();
				respawn.P1StartRespawn ();
				Destroy (gameObject);
		...
		if (hit3)
		{
			if (hit3.collider.tag == "Block" && hitC == false)
			{
				Player1.player.Squish();
				respawn.P1StartRespawn ();
				Destroy (gameObject);
		...
		if (hit4)
		{
			if (hit4.collider.tag == "Block" && hitC == false)
			{
				Player1.player.Squish();
				respawn.P1StartRespawn ();
				Destroy (gameObject);
